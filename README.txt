...
PyjsArray module provides Python objects that wrap the JavaScript TypedArray objects. It was designed for use in Python-to-JavaScript applications that are translated with the Pyjs compiler (https://pyjs.org), as part of the Pyjsdl library (https://github.com/jggatc/pyjsdl). The module provides the following TypedArray objects: Uint8ClampedArray, Uint8Array, Uint16Array, Uint32Array, Int8Array, Int16Array, Int32Array, Float32Array, Float64Array.
...
PyjsArray git: https://github.com/jggatc/pyjsarray
